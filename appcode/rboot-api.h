 ...
 */
uint32 rboot_get_slot_offset(uint8_t slot);
...
**/
bool rboot_verify_image(uint32 offset, uint32 *image_length, const char **error_message);
...
**/
bool rboot_digest_image(uint32 offset, uint32 image_length, rboot_digest_update_fn update_fn, void *update_ctx);
